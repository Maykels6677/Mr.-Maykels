...
echo  "|           Root®Autor : Gloryus Man                   |" | lolcat

echo  "|           Youtube : Gloryus Man          |" | lolcat
...
echo $me"┌==="$bi"["$i"Gloryus Man"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
...
echo $ku"Youtube :"$i" Gloryus Man"

echo $ku"Facebook :"$i" Gloryus Man"

echo $ku"Instagram :"$i" Gloryus Man"
